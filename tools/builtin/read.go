...
func (ReadTool) Description() string {
	return "Read file contents from a path under the working directory or under allowed memory roots (including ~/.oneclaw for user memory). Text only; capped at 256KiB."
}
